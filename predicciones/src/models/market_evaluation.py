...
def evaluate_core_market_set(
    ...
    market_specs = [
        ("1x2_home", f"{home_team} win", predictions["1x2"]["home"]),
        ("1x2_draw", "Draw", predictions["1x2"]["draw"]),
        ("1x2_away", f"{away_team} win", predictions["1x2"]["away"]),
        ("double_chance_home_or_draw", f"{home_team} or Draw", predictions["double_chance"]["home_or_draw"]),
        ("double_chance_away_or_draw", f"{away_team} or Draw", predictions["double_chance"]["away_or_draw"]),
        ("double_chance_home_or_away", f"{home_team} or {away_team}", predictions["double_chance"]["home_or_away"]),
        ("over_1_5", "Over 1.5 goals", predictions["over_under"]["over_1_5"]),
        ("under_1_5", "Under 1.5 goals", predictions["over_under"]["under_1_5"]),
        ("over_2_5", "Over 2.5 goals", predictions["over_under"]["over_2_5"]),
        ("under_2_5", "Under 2.5 goals", predictions["over_under"]["under_2_5"]),
        ("over_3_5", "Over 3.5 goals", predictions["over_under"]["over_3_5"]),
        ("under_3_5", "Under 3.5 goals", predictions["over_under"]["under_3_5"]),
        ("over_4_5", "Over 4.5 goals", predictions["over_under"]["over_4_5"]),
        ("under_4_5", "Under 4.5 goals", predictions["over_under"]["under_4_5"]),
        ("btts_yes", "BTTS: Yes", predictions["btts"]["yes"]),
